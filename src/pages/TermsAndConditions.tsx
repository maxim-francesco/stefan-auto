        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="prose prose-invert max-w-none text-muted-foreground leading-relaxed space-y-6">
              ...
              <p>
                Ne străduim să oferim descrieri cât mai exacte și complete ale autoturismelor listate. Totuși, pot exista erori umane. Fotografiile au caracter informativ. Prețurile sunt exprimate în EURO și, dacă nu se specifică altfel, includ TVA. Ne rezervăm dreptul de a modifica prețurile fără o notificare prealabilă.
              </p>
